...
export const FORMATIONS: Formation[] = [
  {
    ...
    positions: [
      ...
      { id: 'm1', name: 'M/C', allowedRoles: ['M', 'C'], x: 40, y: 55 },
      { id: 'm2', name: 'M/C', allowedRoles: ['M', 'C'], x: 60, y: 55 },
  ...
  },
  {
    ...
    positions: [
      ...
      { id: 't1', name: 'T', allowedRoles: ['T'], x: 40, y: 35 },
      { id: 't2', name: 'T', allowedRoles: ['T'], x: 60, y: 35 },
