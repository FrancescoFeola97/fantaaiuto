...
export const FORMATIONS: Formation[] = [
  ...
  // 3-4-2-1 (corrected according to guide)
  {
    id: '3-4-2-1',
    name: '3-4-2-1',
    displayName: '3-4-2-1',
  ...
  // 3-5-2 (corrected according to guide)
  {
    id: '3-5-2',
    name: '3-5-2',
    displayName: '3-5-2',
  ...
  // 3-5-1-1 (corrected according to guide)
  {
    id: '3-5-1-1',
    name: '3-5-1-1',
    displayName: '3-5-1-1',
    positions: [
      ...
      // Attacking Midfielder (1)
      { id: 'ta1', name: 'T/A', allowedRoles: ['T', 'A'], x: 50, y: 30 },
  ...
  // 4-3-3 (corrected according to guide)
  {
    id: '4-3-3',
    name: '4-3-3',
    displayName: '4-3-3',
    positions: [
      ...
      { id: 'c1', name: 'C', allowedRoles: ['C'], x: 65, y: 50 },
  ...
  // 4-3-1-2 (corrected according to guide)
  {
    id: '4-3-1-2',
    name: '4-3-1-2',
    displayName: '4-3-1-2',
    positions: [
      ...
      // Forwards (2)
      { id: 'ta1', name: 'T/A/PC', allowedRoles: ['T', 'A', 'Pc'], x: 40, y: 15 },
      { id: 'a2', name: 'A/PC', allowedRoles: ['A', 'Pc'], x: 60, y: 15 },
    ]
  },

  // 4-4-2 (corrected according to guide)
  {
    id: '4-4-2',
    name: '4-4-2',
    displayName: '4-4-2',
    positions: [
      ...
      // Midfielders (4)
      { id: 'm1', name: 'E/W', allowedRoles: ['E', 'W'], x: 25, y: 50 },
      { id: 'c1', name: 'C', allowedRoles: ['C'], x: 42, y: 45 },
      { id: 'ew1', name: 'M/C', allowedRoles: ['M', 'C'], x: 58, y: 45 },
      { id: 'e1', name: 'E', allowedRoles: ['E'], x: 75, y: 50 },
  ...
  // 4-1-4-1 (corrected according to guide)
  {
    id: '4-1-4-1',
    name: '4-1-4-1',
    displayName: '4-1-4-1',
    positions: [
      ...
      // Midfielders (2)
      { id: 'ct1', name: 'C/T', allowedRoles: ['C', 'T'], x: 35, y: 45 },
      { id: 't1', name: 'T', allowedRoles: ['T'], x: 65, y: 45 },
      
      // Wings (2)
      { id: 'ew1', name: 'E/W', allowedRoles: ['E', 'W'], x: 20, y: 30 },
      { id: 'w1', name: 'W', allowedRoles: ['W'], x: 80, y: 30 },
  ...
  // 4-4-1-1 (corrected according to guide)
  {
    id: '4-4-1-1',
    name: '4-4-1-1',
    displayName: '4-4-1-1',
    positions: [
      ...
      // Midfielders (2)
      { id: 'm1', name: 'M', allowedRoles: ['M'], x: 35, y: 55 },
      { id: 'c1', name: 'C', allowedRoles: ['C'], x: 65, y: 55 },
      
      // Attacking Midfielders (3)
      { id: 'ew1', name: 'E/W', allowedRoles: ['E', 'W'], x: 25, y: 35 },
      { id: 'ta1', name: 'T/A', allowedRoles: ['T', 'A'], x: 50, y: 30 },
      { id: 'ew2', name: 'E/W', allowedRoles: ['E', 'W'], x: 75, y: 35 },
  ...
  // 4-2-3-1 (corrected according to guide)
  {
    id: '4-2-3-1',
    name: '4-2-3-1',
    displayName: '4-2-3-1',
    positions: [
      ...
      // Attacking Midfielders (3)
      { id: 'wt1', name: 'W/T', allowedRoles: ['W', 'T'], x: 25, y: 35 },
      { id: 't1', name: 'T', allowedRoles: ['T'], x: 50, y: 30 },
      { id: 'wa1', name: 'W/A', allowedRoles: ['W', 'A'], x: 75, y: 35 },
